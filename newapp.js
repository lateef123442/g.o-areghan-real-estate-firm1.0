...
// ==================== IMAGE PATH HELPER ====================
// Multer may save:
//   (a) relative path:  "uploads/images/xxx.jpg"
//   (b) absolute path:  "/home/u166499615/domains/site/uploads/images/xxx.jpg"
// Both must be converted to a URL-safe "/uploads/images/xxx.jpg".
function normalizeImagePaths(paths) {
    ...
    return paths.split(',')
        .map(p => {
            ...
            // Extract the "uploads/..." portion from absolute OS paths
            // e.g. /home/user/site/public_html/uploads/images/x.jpg → /uploads/images/x.jpg
            const uploadsIdx = p.indexOf('uploads/');
            if (uploadsIdx !== -1) {
                return '/' + p.slice(uploadsIdx);
            }
            // Already a clean relative path — just ensure leading slash
